...
dt.unlabelled$aktMotif <- as.numeric(lapply(dt.unlabelled$Seq.Window, getMatchScore, PSSM=aktSequences.pfm))
dt.unlabelled$mTORMotif <- as.numeric(lapply(dt.unlabelled$Seq.Window, getMatchScore, PSSM=mTORSequences.pfm))
...
head(dt.unlabelled)
max(dt.unlabelled$aktMotif)
min(dt.unlabelled$aktMotif)
