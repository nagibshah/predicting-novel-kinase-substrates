...
features <- tstatSort(dt.feature.selection.akt)
...
test.accuracies <- backwardStepwise(train = dt.feature.selection.akt[,-17],
                                    cls.train = dt.feature.selection.akt[,17],
...
plot(rev(test.accuracies),type="l",ylim=c(0.8, 1), xaxt="n", ylab="Test accuracies", xlab="Number of features sorted")
