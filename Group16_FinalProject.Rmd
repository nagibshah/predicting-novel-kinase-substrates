...
# function to build model 
model.adp.func <- function (dt.model.full, dt.labeled, cost.n, degree.n) {
...
Akt.final.adp <- model.adp.func(dt.Akt.fulmodel, dt.Akt, 1, 1)
...
mTOR.final.adp <- model.adp.func(dt.mTOR.fulmodel, dt.mTOR, 1, 1)
