...
Akt.neg <- dt.Akt.fulmodel[which(dt.Akt.fulmodel$Identifier %in% 
                                   aktNancies[aktNancies$predictResult < 0.3, ]$Identifier 
...
for(x in c(10,50,100,300,500,800,1000, 1200)) { # seq(200, 1000, by=200)
  Akt.adp2 <- model.adp2.func(dt.Akt.fulmodel, dt.Akt, Akt.neg, 1.1, 1, dt.Akt.fulmodel[, 2:17],x)
...
plot(x=ensembleCorrelations2[,2],y=ensembleCorrelations2[,1],ylab="Correlations", xlab="Ensemble Size",main="Optimum Ensemble size",col="red",pch=20)
...
for(x in c(10,50,100,300,500,800,1000, 1200)) { # seq(200, 1000, by=200)
  mTOR.adp2 <- model.adp2.func(dt.mTOR.fulmodel, dt.mTOR, mTOR.neg, 1.1, 1, dt.mTOR.fulmodel[, 2:17],x)
