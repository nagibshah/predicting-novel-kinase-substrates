...
print("SVM Radial is understood to be a squared exponential kernel and as such categegorised as  non-parametric method. On the other hand SVM Poly kernel and linear kernels are parametric. 
...
plot(dt.Akt.fulmodel[, c("Avg.Fold","aktMotifMatch")],col="gray", pch=20, main="After Positive unlabeled Learning")
...
plot(dt.mTOR.fulmodel[, c("Avg.Fold","mTORMotifMatch")],col="gray", pch=20, main="After Positive unlabeled Learning")
